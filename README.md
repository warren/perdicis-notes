...
2) When it's time to publish, I run `rm content/*` , `python3 misc/get_notes.py` , and then `git restore content/index.md`. Then `npx quartz sync`. There's a simple shell script to do this called `restage.sh`
3) Goto 1
