...
## Appendix
### Finding other pages
A fun way to discover more pages would be slamming a "Random article" button. One day I'll put that button here. For now, you can find it in the 404 page, which you can reach by typing nonsense into your browser bar after the forward slash, like `notes.perdicis.com/Nonsense` 
