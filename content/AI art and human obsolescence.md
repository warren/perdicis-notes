...
People will disagree whether (A) or (B) is more likely. It'll depend on what you consider "good" art (a whole topic on its own). I'm torn on it because I suspect AI artists will result in a ton of generic art flooding the internet. Is generic == bad? Right now I feel the answer is "no," but maybe I'll change my mind.
...
A strong argument against this section is that "created" != "discovered." That is -- even if a great artist is out there somewhere, they'll have a harder time standing out. I don't have a great answer to this but I hope it doesn't turn out that way.

## Appendix
I glossed over some huge topics that usually come up when discussing this AI so I'll try to cover them below.
...
This is actually pretty true imo. The job of a stable diffusion model is to extrapolate words (a tiny dimensional space) into a whole image (huge dimensional space). There's so much room for randomness that the best models are differentiated by their method of effectively injecting randomness.
...
### The future of the robo-paintbrush
